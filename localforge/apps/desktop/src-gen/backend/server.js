...
module.exports = async (port, host, argv) => {
    try {
        ...
        await load(require('@theia/plugin-ext-headless/lib/plugin-ext-headless-electron-module'));
        await load(require('@theia/api-provider-sample/lib/node/gotd-backend-module'));
        ...
        await load(require('@localforge/app-blueprints/lib/node/app-blueprints-backend-module'));
